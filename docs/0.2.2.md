...
- stopError(func): error catcher & logger used to stop error propogation when running unit functions, and in some other areas of the framework. You may want to override this method to support whatever error logging code or service you use.
