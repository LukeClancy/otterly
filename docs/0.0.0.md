...
### SPA
skipping non-facing...
- navigationReplaces: css selector attribute to optionally not switch out the body.
...
- linkClickedF(e): link has been clicked function. Determines how to deal with it.
